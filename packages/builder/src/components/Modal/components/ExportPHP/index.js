...
const ExportPHP = ({ closeHandler }, { store }) =>
  ...
  >
    ...
    <Alert color="danger">
      <strong>Though we do our best, we cannot take responsibility for code the runs on your server.</strong> Please make sure to <a href="http://labjs.readthedocs.io/en/latest/learn/deploy/" className="alert-link" style={{ fontWeight: 600 }} target="_blank" rel="noopener noreferrer">consult the documentation on how to set up data collection correctly</a>, and ask your friendly neighborhood IT staff if you're unsure.
    </Alert>
  </Confirm>
