...
const ExportPM = ({ closeHandler }, { store }) =>
  ...
  >
    ...
    <p>Please check out our documentation to <a href="https://labjs.readthedocs.io/en/latest/learn/deploy/third-party">find out how to use <code>lab.js</code> in combination with third-party software</a>.</p>
  </Confirm>
